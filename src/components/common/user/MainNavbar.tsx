  ...
  const NavbarContent = () => (
    <>
      ...
      <Link to="/profile" className="flex items-center">
        ...
        <button className="orange-button text-white text-l focus:outline-none border-2 border-[#FF5F09] px-4 py-2 font-bold font-orbitron">
    ...
    <nav className="bg-black text-white p-4 w-full z-40 sticky top-0 left-0 right-0">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center">
          {userInfo && userInfo.displayName && <NavbarContent />}
        </div>
